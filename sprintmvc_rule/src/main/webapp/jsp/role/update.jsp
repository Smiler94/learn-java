...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <div style="padding:15px">
            <form action="/role/update" class="layui-form" method="post">
                <div class="layui-form-item">
                    <label for="id" class="layui-form-label">权限ID</label>
                    <div class="layui-input-inline" style="width:300px">
                        <input id="id" type="text" class="layui-input" name="id" lay-verify="id" value="${role.id}" readonly/>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <c:forEach items="${auths}" var="authority" varStatus="status">
                            <c:if test="${authority.has}">
                                <input type="checkbox" name="auths[]" value="${authority.id}" title="${authority.name}" checked/>
                            </c:if>
                            <c:if test="${!authority.has}">
